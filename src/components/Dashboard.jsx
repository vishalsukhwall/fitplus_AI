...
export default function Dashboard({
  ...
  const kpis = [
    {
      ...
      change: '+14.2% overload',
      positive: true,
      color: '#34d399',
      icon: Dumbbell,
      subtext: 'Progression on track for peak week',
    },
    {
      title: 'Metabolic Output Today',
      value: '2,840 kcal',
      change: '+310 kcal burned',
      positive: true,
      color: '#fb923c',
      icon: Flame,
      subtext: '52 min active heart rate zones',
    },
    {
      title: 'Consistency Habit Streak',
      value: '34 Days',
      change: 'Personal All-Time High',
      positive: true,
      color: '#c084fc',
      icon: Zap,
      subtext: '34 straight days hitting macro goals',
    },
    {
      ...
      color: '#2dd4bf',
      icon: HeartPulse,
      subtext: 'Ready for maximal barbell loads',
    },
  ]
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              Command Center Workspace: <span className="text-neon-gradient">Alex Rivera</span>
            </h2>
            <p className="text-slate-400 text-sm mt-1 max-w-xl">
              Sleep telemetry indicates 8h 14m restorative deep sleep. Your recovery score is 94%. Today’s prescribed training block is Upper Body Hypertrophy.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Continuous sensor biometric curve mapped with daily metabolic output
            </p>
          </div>
      ...
      {/* 2-Column Split: Active Workout Checklist & Real-Time Macro Allocation */}
